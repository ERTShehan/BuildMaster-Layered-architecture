...
import com.assignment.buildmasternew.AppInitializer;
import com.assignment.buildmasternew.model.UserModel;
...
public class LoginFormController {
    ...
    void onSignAction(ActionEvent event) throws IOException {
        ...
        if(email.isEmpty() || password.isEmpty()){
            ...
            boolean logging = userModel.verifyUser(email, password);
            logging = true;
            if (!logging) {

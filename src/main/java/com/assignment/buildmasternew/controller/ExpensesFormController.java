...
import com.assignment.buildmasternew.model.EmployeeModel;
...
public class ExpensesFormController implements Initializable {
    ...
    void cmbEmployeeIdLoadExpenses(ActionEvent event) throws SQLException {
        ...
        if (selectedEmployeeId != null) {
            lblExpenseEmployeeName.setText(employeeModel.getName(selectedEmployeeId));
            lblExpenseEmployeeRole.setText(employeeModel.getRole(selectedEmployeeId));
        }
    ...
    void cmbExpenseIdOnAction(ActionEvent event) throws SQLException {
        ...
        if (selectedExpenseId != null) {
            ExpensesDto expensesDto = expensesModel.findById(selectedExpenseId);
    ...
    void cmbProjectIdLoadExpenses(ActionEvent event) throws SQLException {
        ...
        if (selectedProjectId != null) {
            lblExpenseProjectName.setText(projectModel.getName(selectedProjectId));
        }
        checkComboBoxSelection();
    }
    ...
    void onExpensesDeleteAction(ActionEvent event) {
        try{
            ...
            if(buttonType.get() == ButtonType.YES){
                boolean isDeleted = expensesModel.deleteExpenses(expenseId);
    ...
    void onExpensesSaveAction(ActionEvent event) throws SQLException {
        ...
        if (validation(type, amountText, date)) {
            try {
                ...
                boolean isSaved = expensesModel.saveExpenses(expensesDto);
    ...
    private void refreshPage() throws SQLException {
        String nextExpensesId = expensesModel.getNextExpensesId();
    ...
    private void loadExpensesIds() throws SQLException {
        ArrayList<String> expensesIds = expensesModel.getAllExpensesIds();
    ...
    private void loadProjectIds() throws SQLException {
        ArrayList<String> projectIds = projectModel.getAllProjectIds();
        ObservableList<String> observableList = FXCollections.observableArrayList();

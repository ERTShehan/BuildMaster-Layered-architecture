...
public class MachineModel {
    ...
    public ArrayList<String> getAllMachineIds() throws SQLException {
        ResultSet rst = CrudUtil.execute("select Machine_ID from Machine");
    ...
    public MachineDto findById(String selectedMachineId) throws SQLException {
        ResultSet rst = CrudUtil.execute("select * from Machine where Machine_ID=?", selectedMachineId);
    ...
    public boolean updateMachine(MachineDto machineDto) throws SQLException {
        ...
        return CrudUtil.execute(sql, machineDto.getName(), machineDto.getStatus(), machineDto.getDescription(), machineDto.getMachineId());
    }
    ...
    public List<MachineDto> getAllMachines() throws SQLException {
        ResultSet resultSet = CrudUtil.execute("SELECT * FROM Machine");
